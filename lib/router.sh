...
#   2. Configuration from .synapserc
#   3. Environment overrides
#
# Configuration (via .synapserc):
#   {
#     "taskModels": {
...
#
# Environment:
#   SYNAPSE_TASK_MODEL_ARCHITECT - Override architect model
#   SYNAPSE_TASK_MODEL_CODEGEN   - Override codegen model
#   SYNAPSE_TASK_MODEL_FIX       - Override fix model
#   SYNAPSE_TASK_MODEL_REVIEW    - Override review model
#   SYNAPSE_TASK_MODEL_TEST      - Override test model
#   SYNAPSE_AUTO_ROUTE           - Enable/disable auto-routing (default: true)
# =============================================================================
...
SYNAPSE_AUTO_ROUTE="${SYNAPSE_AUTO_ROUTE:-true}"

# =============================================================================
# Configuration Loading
# =============================================================================

# Load task router configuration from .synapserc
...
load_task_router_config() {
    ...
    [ -n "${SYNAPSE_TASK_MODEL_ARCHITECT:-}" ] && TASK_MODEL_ARCHITECT="$SYNAPSE_TASK_MODEL_ARCHITECT"
    [ -n "${SYNAPSE_TASK_MODEL_CODEGEN:-}" ] && TASK_MODEL_CODEGEN="$SYNAPSE_TASK_MODEL_CODEGEN"
    [ -n "${SYNAPSE_TASK_MODEL_FIX:-}" ] && TASK_MODEL_FIX="$SYNAPSE_TASK_MODEL_FIX"
    [ -n "${SYNAPSE_TASK_MODEL_REVIEW:-}" ] && TASK_MODEL_REVIEW="$SYNAPSE_TASK_MODEL_REVIEW"
    [ -n "${SYNAPSE_TASK_MODEL_TEST:-}" ] && TASK_MODEL_TEST="$SYNAPSE_TASK_MODEL_TEST"
...
print_routing_config() {
    ...
    echo "========================="
    echo "Auto-routing: $SYNAPSE_AUTO_ROUTE"
    echo ""
